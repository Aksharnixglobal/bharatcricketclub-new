...
export default function App() {
  ...
  // Dynamic Live Matches state connected to Dallas Cricket League (Team 308)
    ...
    <>
      ...
      <section id="fixtures" className="section">
        <div className="container">
          ...
          <p className="section-subtitle">
            Follow Bharat CC cricket matches, review official league scorecards, and stay updated with upcoming games.
          </p>
